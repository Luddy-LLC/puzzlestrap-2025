...
/* harmony export */   MP_Nav: () => (/* binding */ MP_Nav),
...
class MP_Nav extends LitElement {
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<p>Hello, ${this.name}!</p>`;
    }
}
customElements.define('mp-nav', MP_Nav);


/***/ })

});
//# sourceMappingURL=Nav-stories.a720f41678e98a0b48eb.hot-update.js.map