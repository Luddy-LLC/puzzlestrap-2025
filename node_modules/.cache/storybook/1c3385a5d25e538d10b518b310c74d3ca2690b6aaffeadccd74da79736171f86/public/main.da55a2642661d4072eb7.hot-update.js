...
class Alert extends HTMLElement {
    ...
    render() {
        ...
        const s = `<style>.alert{display:flex;justify-content:left;align-items:center;gap:15px;width:calc(100% - 66px);padding:15px 20px;margin:10px;border-radius:.75em;font-family:'Space Mono','Inter',sans-serif;color:hwb(210 87% 6%);border:3px solid hwb(210 20% 55%);background-color:hwb(210 20% 70% / .9);svg{color:hwb(210 87% 6%)}&.success{color:hwb(132 87% 6%);border:3px solid hwb(132 20% 55%);background-color:hwb(132 20% 70% / .9);svg{color:hwb(132 87% 6%)}}&.warning{color:hwb(47 87% 6%);border:3px solid hwb(47 20% 55%);background-color:hwb(47 20% 70% / .9);svg{color:hwb(47 87% 6%)}}&.failure{color:hwb(0 87% 6%);border:3px solid hwb(0 20% 55%);background-color:hwb(0 20% 70% / .9);svg{color:hwb(0 87% 6%)}}}</style>`;
        ...
        <div class="mp-offcanvas">
            <div class="offcanvas-panel" role="dialog"
                ...
                <div class="oc-body">
                    ...
                    <mp-alert hidden id="correct" label="Correct! Great job." type="success"></mp-alert>
                    <mp-alert hidden id="incorrect" label="Not quite... Try again." type="failure"></mp-alert>
                    <mp-alert hidden id="technical-error" label="Oops! There's been a technical issue. Try again later." type="warning"></mp-alert>
                </div>
...
//# sourceMappingURL=main.da55a2642661d4072eb7.hot-update.js.map