...
class OffCanvas extends HTMLElement {
    connectedCallback() {
        // const title = this.getAttribute('puzzle-title');
        // const solveable = this.getAttribute('is-solveable') == "true" ? "flex" : "none";
        this.innerHTML = `<button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#hints" aria-controls="hints">Enable both scrolling & backdrop</button>
...
//# sourceMappingURL=Nav-stories.06a44ed3d1531c25524a.hot-update.js.map