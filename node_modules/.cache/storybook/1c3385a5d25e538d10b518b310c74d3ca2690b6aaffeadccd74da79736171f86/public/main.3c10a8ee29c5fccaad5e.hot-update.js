...
class OffCanvas extends HTMLElement {
    ...
    connectedCallback() {
        this.render().then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this));
    }
    attributeChangedCallback() {
        this.render();
    }
    ...
    connectedCallback() {
        ...
        fetch('puzzles.json').then((response)=>response.json()).then((data)=>{
            ...
            fetch('logic/shipdialogue.json').then((response)=>response.json()).then((data)=>{
                ...
                this.render(h, footerMessage).then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this));
    ...
    connectedCallback() {
        fetch('puzzles.json').then((response)=>response.json()).then((data)=>{
            ...
            fetch('logic/shipdialogue.json').then((response)=>response.json()).then((data)=>{
                ...
                this.render(archiveText, footerMessage).then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this));
            }).catch((error)=>console.log(error));
        }).catch((error)=>console.log(error));
        (0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this);
    }
    attributeChangedCallback() {
        this.render();
    }
...
class Music extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        songInfo.song != "none" ? this.render(songInfo, footerMessage).then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this)) : this.render({
            "song": "Silence.",
            "artist": "There's nothing like 4:33.",
            "file": ""
        }, footerMessage).then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this));
    }
    connectedCallback() {
        fetch('puzzles.json').then((response)=>response.json()).then((data)=>{
            ...
            fetch('logic/shipdialogue.json').then((response)=>response.json()).then((data)=>{
                ...
                song != "none" ? this.render(song, footerMessage).then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this)) : this.render({
                    "song": "Silence.",
                    "artist": "There's nothing like 4:33.",
                    "file": ""
                }, footerMessage).then((0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)(this));
...
//# sourceMappingURL=main.3c10a8ee29c5fccaad5e.hot-update.js.map