...
class Input extends HTMLElement {
    ...
    render() {
        ...
        const c = `<div class="form-group"><input type="text" class="mp-input" id="${this.getAttribute("field-id")}" placeholder="${this.getAttribute("placeholder")}" name="${this.getAttribute("field-id")}" type="" required><label for="${this.getAttribute("field-id")}">${this.getAttribute("label")}</label></div>`;
        shadowRoot.innerHTML = `${s}\n${c}`;
    }
    connectedCallback() {
        this.render();
...
//# sourceMappingURL=main.2edc63b6e618a9b5d841.hot-update.js.map