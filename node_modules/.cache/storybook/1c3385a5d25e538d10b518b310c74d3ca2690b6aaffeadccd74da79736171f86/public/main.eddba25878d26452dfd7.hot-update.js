...
class OffCanvas extends HTMLElement {
    ...
    connectedCallback() {
        this.render();
        (0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)();
    }
    attributeChangedCallback() {
        this.render();
    }
...
class Solve extends HTMLElement {
    ...
    connectedCallback() {
        ...
        try {
            document.getElementById('login-form').addEventListener("submit", loginSubmission);
        } catch  {}
        (0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.offCanvasMeta)();
    }
    attributeChangedCallback() {
...
/* harmony export */   offCanvasMeta: () => (/* binding */ offCanvasMeta),
...
// offCanvasMeta() adds event listeners for updating theme-color meta when offcanvases are opened
function offCanvasMeta() {
    var meta = document.querySelector("meta[name='theme-color']");
    const metaColour = meta.content;
    this.children[0].firstElementChild.addEventListener("toggle", (e)=>{
...
//# sourceMappingURL=main.eddba25878d26452dfd7.hot-update.js.map