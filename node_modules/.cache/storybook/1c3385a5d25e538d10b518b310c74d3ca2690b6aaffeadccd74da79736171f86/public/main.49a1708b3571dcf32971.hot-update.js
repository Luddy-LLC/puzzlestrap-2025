...
class Solve extends HTMLElement {
    ...
    connectedCallback() {
        ...
        function answerSubmission(event1) {
        ...
        document.getElementById('solve-menu').addEventListener("toggle", (event1)=>{
            if (event1.newState === "closed") clearAnswer();
        });
        try {
...
//# sourceMappingURL=main.49a1708b3571dcf32971.hot-update.js.map