...
class Nav extends HTMLElement {
    connectedCallback() {
        ...
        <style>@import "stories/nav.css"</style>
        ...
        <ul role="menubar" aria-label="functions">
            ...
            <li role="none">
                <button class="nav-button" role="menuitem" style="display:${solveable}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
class Hints extends HTMLElement {
    connectedCallback() {
        ...
        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#hints" aria-controls="hints">Enable both scrolling & backdrop</button>

        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="hintOC" aria-labelledby="offcanvasWithBothOptionsLabel">
        ...
        <script>
        const oc = new bootstrap.Offcanvas('#hintOC')
        const ocList = document.querySelectorAll('.offcanvas')
        const offcanvasList = [...ocList].map(offcanvasEl => new bootstrap.Offcanvas(offcanvasEl))
        </script>
        `;
    }
}
customElements.define("mp-hints", OffCanvas);


/***/ })

});
//# sourceMappingURL=Nav-stories.d3486d09535362dd345d.hot-update.js.map