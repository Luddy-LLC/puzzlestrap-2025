 ...
 * ## Usage Notes
 * Be careful when using alert. `info` alerts are "silent" to screen readers and can be used for purely informational contexts. `success`,`warning`, and `failure` alerts, when visible, will interupt the screen reader and jump the user to the content. These should only be used when necessary to inform the user of a successful or failed action.
 */
...
//# sourceMappingURL=Alert-stories.66b7f4db2b41a3be6ef0.hot-update.js.map