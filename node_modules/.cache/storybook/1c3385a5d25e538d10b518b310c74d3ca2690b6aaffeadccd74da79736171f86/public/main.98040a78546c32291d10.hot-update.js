...
class Nav extends HTMLElement {
    ...
    render() {
        ...
        <ul role="menubar" aria-label="functions">
            ...
            <li role="presentation"><buttonpo povertarget="archive-menu" class="nav-button" role="menuitem"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <li role="presentation"><button popovertarget="solve-menu" class="nav-button" role="menuitem"
                    style="display:${this.getAttribute('is-solveable') == 'true' ? 'flex' : 'none'}"><svg
    ...
    <nav class="mobile-nav">
        <ul role="menubar" aria-label="functions">
            ...
            <div class="mn-bottom">
                ...
                <li role="presentation"><button popovertarget="solve-menu" class="nav-button" role="menuitem"
                        style="display:${this.getAttribute('is-solveable')}"><svg xmlns="http://www.w3.org/2000/svg"
...
//# sourceMappingURL=main.98040a78546c32291d10.hot-update.js.map