...
class Solve extends HTMLElement {
    ...
    render() {
        const person = (0,_logic_check_js__WEBPACK_IMPORTED_MODULE_0__.getPerson)();
        this.innerHTML = `
        <div class="mp-offcanvas">
    ...
    connectedCallback() {
        ...
        (0,_logic_check_js__WEBPACK_IMPORTED_MODULE_0__.autoFill)();
        function preventDefaultSubmission(event) {
            event.preventDefault();
            (0,_logic_check_js__WEBPACK_IMPORTED_MODULE_0__.checkAnswer)(document.getElementById('team').value, document.getElementById('name').value, document.getElementById('puzzle').value, document.getElementById('answer').value.toLowerCase()).then((response)=>{
        ...
        document.getElementById('solve-menu').addEventListener("toggle", (event)=>{
            if (event.newState === "open") (0,_logic_check_js__WEBPACK_IMPORTED_MODULE_0__.autoFill)();
        });
        document.getElementById('solve-menu').addEventListener("toggle", (event)=>{
            if (event.newState === "closed") (0,_logic_check_js__WEBPACK_IMPORTED_MODULE_0__.clearAnswer)();
        });
...
//# sourceMappingURL=main.a15f2bf115a07036daf4.hot-update.js.map