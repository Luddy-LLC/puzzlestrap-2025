...
class Input extends HTMLElement {
    ...
    render() {
        ...
        const c = `<div class="form-group"><input class="mp-input" id="${this.getAttribute("field-id")}" placeholder="${this.getAttribute("placeholder")}" name="${this.getAttribute("field-id")}" type="${this.getAttribute("type")}" autocomplete="${this.getAttribute("autocomplete")}" required oninvalid="alert('invalid!')"><label for="${this.getAttribute("field-id")}">${this.getAttribute("label")}</label></div>`;
        shadowRoot.innerHTML = `${s}\n${c}`;
    }
    connectedCallback() {
        this.render();
...
//# sourceMappingURL=main.546e0d31a4ec9d33938d.hot-update.js.map