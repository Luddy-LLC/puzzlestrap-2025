...
class Input extends HTMLElement {
    ...
    render() {
        ...
        const c = `<div class="form-group"><input class="mp-input" id="${this.getAttribute("field-id")}" placeholder="${this.getAttribute("placeholder")}" name="${this.getAttribute("field-id")}" type="${this.getAttribute("type")}" autocomplete="${autocomplete}" required><label for="${this.getAttribute("field-id")}">${this.getAttribute("label")}</label></div>`;
        shadowRoot.innerHTML = `${s}\n${c}`;
    }
    connectedCallback() {
        this.render();
...
//# sourceMappingURL=main.2d34d899b3f32f7e63e1.hot-update.js.map