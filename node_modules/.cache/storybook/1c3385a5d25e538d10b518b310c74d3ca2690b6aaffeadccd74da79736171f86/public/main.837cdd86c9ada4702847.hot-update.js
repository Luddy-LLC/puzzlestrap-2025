...
*/ class Alert extends HTMLElement {
    ...
    render() {
        ...
        const c = `<div class="alert ${this.getAttribute("type") ?? ""}" ${this.getAttribute("type") == "warning" || this.getAttribute("type") == "failure" || this.getAttribute("success") == "failure" ? "role='alert'" : ""}>
...
//# sourceMappingURL=main.837cdd86c9ada4702847.hot-update.js.map