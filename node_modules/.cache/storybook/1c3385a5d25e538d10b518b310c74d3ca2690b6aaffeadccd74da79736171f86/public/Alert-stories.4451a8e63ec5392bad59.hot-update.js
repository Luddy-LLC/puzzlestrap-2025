 ...
 * ## Usage Notes
 * Be careful when using alert. `info` alerts are "silent" to screen readers and can be used for purely informational contexts. `success`,`warning`, and `failure` alerts, when visible, will interupt a screen readers to jump the user to the content. These should only be used when necessary to inform the user of a successful or failed action.
 */
...
//# sourceMappingURL=Alert-stories.4451a8e63ec5392bad59.hot-update.js.map