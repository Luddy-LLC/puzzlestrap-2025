...
class Nav extends HTMLElement {
    ...
    render() {
        var attr = {};
        for(a in self.observedAttributes){
            console.log(a);
            attr[camelize(a)] = this.getAttribute(a);
        }
...
<nav class="desktop-nav">
    <ul role="menubar" aria-label="functions">
        ...
        <li role="none">
            <h1 class="puzzle-title" role="none" aria-label="">${self.observedAttributes["title"]}</h1>
        </li>
        <li role="none">
        ...
        <li role="none">
            <button class="nav-button" role="menuitem" style="display:${attr["isSolveable"] == "true" ? "flex" : "none"}">
                <svg
...
<nav class="mobile-nav">
    <ul role="menubar" aria-label="functions">
        <div class="mn-top">
            ...
            <li role="none">
                <h1 class="puzzle-title" role="none" aria-label="">${attr["title"]}</h1>
            </li>
        </div>
        <div class="mn-bottom">
            <li role="none">
            ...
            <li role="none">
                <button class="nav-button" role="menuitem" style="display:${attr["isSolveable"]}">
                    <svg
                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z" />
                    </svg>
...
//# sourceMappingURL=Nav-stories.4df0105fd72c9d40c945.hot-update.js.map