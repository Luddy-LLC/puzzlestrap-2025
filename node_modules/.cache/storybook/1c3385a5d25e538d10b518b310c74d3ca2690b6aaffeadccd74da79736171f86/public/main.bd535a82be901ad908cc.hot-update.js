...
class Input extends HTMLElement {
    ...
    render() {
        ...
        const c = `<div class="form-group"><input type="text" class="mp-input" id="${this.getAttribute("field-id")}" placeholder="${this.getAttribute("placeholder")}" name="${this.getAttribute("field-id")}" required><label for="${this.getAttribute("field-id")}">${this.getAttribute("label")}</label></div>`;
        shadowRoot.innerHTML = `${s}\n${c}`;
    }
    connectedCallback() {
        this.render();
...
//# sourceMappingURL=main.bd535a82be901ad908cc.hot-update.js.map