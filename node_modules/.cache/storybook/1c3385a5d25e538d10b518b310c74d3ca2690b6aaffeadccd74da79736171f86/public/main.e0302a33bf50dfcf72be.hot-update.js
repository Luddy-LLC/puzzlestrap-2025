...
class Input extends HTMLElement {
    ...
    render() {
        ...
        const c = `<div class="form-group"><input class="mp-input" id="${this.getAttribute("field-id")}" placeholder="${this.getAttribute("placeholder")}" name="${this.getAttribute("field-id")}" type="${this.getAttribute("type")}" required><label for="${this.getAttribute("field-id")}">${this.getAttribute("label")}</label></div>`;
        shadowRoot.innerHTML = `${s}\n${c}`;
    }
    connectedCallback() {
        this.render();
...
//# sourceMappingURL=main.e0302a33bf50dfcf72be.hot-update.js.map