        ...
        if (!(0,_logic_helper_js__WEBPACK_IMPORTED_MODULE_0__.loginNeeded)()) {
            ...
            <div class="mp-offcanvas">
                <div class="offcanvas-panel" role="dialog"
                    ...
                    <div class="oc-footer">
                        <p>Hello, <span class="bi">${nameCookie}</span>! You're submitting as a member of team <span class="bi">${teamCookie}</span>. <a class="plain underline" href="/">Switch User</a></p>
                    </div>
                </div>
            </div>
            `;
    ...
    connectedCallback() {
        ...
        try {
            document.getElementById('login-form').addEventListener("submit", (e)=>{
                e.preventDefault();
                loginUser(document.getElementById('team').value, document.getElementById('name').value);
                this.render();
            });
        } catch  {}
        var meta = document.querySelector("meta[name='theme-color']");
