 ...
 * ## Usage Notes
 * Be careful when using alert. `info` alerts are "respectful" to screen readers and can be used for purely informational contexts. `success`,`warning`, and `failure` alerts use `role="alert"` and, when visible, will interupt the screen reader and jump the user to the alert. These should only be used when necessary to inform the user of a successful or failed action. [Overuse of this role could be harmful. Learn more at MDN.](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/alert_role)
 */
...
//# sourceMappingURL=Alert-stories.c5f66778395d3edcf911.hot-update.js.map