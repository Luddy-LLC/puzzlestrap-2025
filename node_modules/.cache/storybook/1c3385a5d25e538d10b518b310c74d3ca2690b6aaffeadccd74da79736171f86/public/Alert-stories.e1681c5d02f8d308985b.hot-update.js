 ...
 * ## Usage Notes
 * Be careful when using alert. `info` alerts are "silent" to screen readers and can be used for purely informational contexts. `success`,`warning`, and `failure` alerts, when visible, will interupt the screen reader and jump the user to the alert. These should only be used when necessary to inform the user of a successful or failed action.
 */
...
//# sourceMappingURL=Alert-stories.e1681c5d02f8d308985b.hot-update.js.map